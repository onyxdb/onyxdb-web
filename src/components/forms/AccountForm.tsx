...
interface AccountFormProps {
    ...
    onSubmit: (values: AccountDTO) => void;
    onClose: () => void;
}
        ...
        <div style={{padding: '20px', maxWidth: '600px', margin: '0 auto'}}>
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <TextAreaField
                    ...
                    onChange={(value) => formik.setFieldValue('data.description', value)}
                    onBlur={formik.handleBlur('data.description')}
                    error={
                ...
                <InputField
                    ...
                    name="phoneNumber"
                    value={formik.values.anyData.phoneNumber ?? ''}
                    onChange={(value) => formik.setFieldValue('data.phoneNumber', value)}
                    onBlur={formik.handleBlur('data.phoneNumber')}
                    error={
                        formik.touched.anyData?.phoneNumber
                            ? formik.errors.anyData?.phoneNumber
                            : undefined
                    }
                ...
                <InputField
                    ...
                    onChange={(value) => formik.setFieldValue('data.jobTitle', value)}
                    onBlur={formik.handleBlur('data.jobTitle')}
                    error={
                ...
                <InputField
                    ...
                    onChange={(value) => formik.setFieldValue('data.workSchedule', value)}
                    onBlur={formik.handleBlur('data.workSchedule')}
                    error={
                ...
                <InputField
                    ...
                    onChange={(value) => formik.setFieldValue('data.dateOfBirth', value)}
                    onBlur={formik.handleBlur('data.dateOfBirth')}
                    error={
                ...
                <InputField
                    ...
                    onChange={(value) => formik.setFieldValue('data.city', value)}
                    onBlur={formik.handleBlur('data.city')}
                    error={formik.touched.anyData?.city ? formik.errors.anyData?.city : undefined}
                    placeholder="Введите город проживания"
                />
                <InputField
                    label="Ссылка на соцсети (Facebook)"
                    name="facebook"
                    value={formik.values.anyData.socialLinks?.facebook ?? ''}
                    onChange={(value) =>
                        formik.setFieldValue('anyData.socialLinks.facebook', value)
                    }
                    onBlur={formik.handleBlur('anyData.socialLinks.facebook')}
                    error={
                        formik.touched.anyData?.socialLinks?.facebook
                            ? formik.errors.anyData?.socialLinks?.facebook
                            : undefined
                    }
                    placeholder="Введите ссылку на Facebook"
                />
                <InputField
                    label="Ссылка на соцсети (LinkedIn)"
                    name="linkedin"
