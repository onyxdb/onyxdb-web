...
export const AccountsApiFactory = function (
    ...
    return {
        ...
        createAccount(
            ...
            return localVarFp
                .createAccount(accountDTO, options)
        ...
        updateAccount(
            ...
            return localVarFp
                .updateAccount(accountId, accountDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export const BusinessRolesApiFactory = function (
    ...
    return {
        ...
        addRoleToBusinessRole(
            ...
            return localVarFp
                .addRoleToBusinessRole(businessRoleId, roleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        createBusinessRole(
            ...
            return localVarFp
                .createBusinessRole(businessRoleDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        deleteBusinessRole(
            ...
            return localVarFp
                .deleteBusinessRole(businessRoleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getBusinessRoleById(
            ...
            return localVarFp
                .getBusinessRoleById(businessRoleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getRolesByBusinessRoleId(
            ...
            return localVarFp
                .getRolesByBusinessRoleId(businessRoleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        removeRoleFromBusinessRole(
            ...
            return localVarFp
                .removeRoleFromBusinessRole(businessRoleId, roleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateBusinessRole(
            ...
            return localVarFp
                .updateBusinessRole(businessRoleId, businessRoleDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class BusinessRolesApi extends BaseAPI {
     ...
     * @memberof BusinessRolesApi
     */
    public createBusinessRole(businessRoleDTO: BusinessRoleDTO, options?: RawAxiosRequestConfig) {
        return BusinessRolesApiFp(this.configuration)
            .createBusinessRole(businessRoleDTO, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BusinessRolesApi
     */
    public deleteBusinessRole(businessRoleId: string, options?: RawAxiosRequestConfig) {
        return BusinessRolesApiFp(this.configuration)
            .deleteBusinessRole(businessRoleId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BusinessRolesApi
     */
    public getBusinessRoleById(businessRoleId: string, options?: RawAxiosRequestConfig) {
        return BusinessRolesApiFp(this.configuration)
            .getBusinessRoleById(businessRoleId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BusinessRolesApi
     */
    public getRolesByBusinessRoleId(businessRoleId: string, options?: RawAxiosRequestConfig) {
        return BusinessRolesApiFp(this.configuration)
            .getRolesByBusinessRoleId(businessRoleId, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const DomainComponentsApiFactory = function (
    ...
    return {
        ...
        createDomainComponent(
            ...
            return localVarFp
                .createDomainComponent(domainComponentDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        deleteDomainComponent(
            ...
            return localVarFp
                .deleteDomainComponent(domainComponentId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getDomainComponentById(
            ...
            return localVarFp
                .getDomainComponentById(domainComponentId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getOrganizationUnitsByDomainComponentId(
            ...
            return localVarFp
                .getOrganizationUnitsByDomainComponentId(domainComponentId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateDomainComponent(
            ...
            return localVarFp
                .updateDomainComponent(domainComponentId, domainComponentDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class DomainComponentsApi extends BaseAPI {
     ...
     * @memberof DomainComponentsApi
     */
    public deleteDomainComponent(domainComponentId: string, options?: RawAxiosRequestConfig) {
        return DomainComponentsApiFp(this.configuration)
            .deleteDomainComponent(domainComponentId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DomainComponentsApi
     */
    public getDomainComponentById(domainComponentId: string, options?: RawAxiosRequestConfig) {
        return DomainComponentsApiFp(this.configuration)
            .getDomainComponentById(domainComponentId, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const OrganizationUnitsApiFactory = function (
    ...
    return {
        ...
        addAccountToOrganizationUnit(
            ...
            return localVarFp
                .addAccountToOrganizationUnit(organizationUnitId, accountId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        createOrganizationUnit(
            ...
            return localVarFp
                .createOrganizationUnit(organizationUnitDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        deleteOrganizationUnit(
            ...
            return localVarFp
                .deleteOrganizationUnit(organizationUnitId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getAccountsByOrganizationUnitId(
            ...
            return localVarFp
                .getAccountsByOrganizationUnitId(organizationUnitId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getOrganizationUnitById(
            ...
            return localVarFp
                .getOrganizationUnitById(organizationUnitId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        removeAccountFromOrganizationUnit(
            ...
            return localVarFp
                .removeAccountFromOrganizationUnit(organizationUnitId, accountId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateOrganizationUnit(
            ...
            return localVarFp
                .updateOrganizationUnit(organizationUnitId, organizationUnitDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class OrganizationUnitsApi extends BaseAPI {
     ...
     * @memberof OrganizationUnitsApi
     */
    public deleteOrganizationUnit(organizationUnitId: string, options?: RawAxiosRequestConfig) {
        return OrganizationUnitsApiFp(this.configuration)
            .deleteOrganizationUnit(organizationUnitId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof OrganizationUnitsApi
     */
    public getOrganizationUnitById(organizationUnitId: string, options?: RawAxiosRequestConfig) {
        return OrganizationUnitsApiFp(this.configuration)
            .getOrganizationUnitById(organizationUnitId, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createOrganization: async (
            ...
            assertParamExists('createOrganization', 'organizationDTO', organizationDTO);
        ...
        deleteOrganization: async (
            ...
            const localVarPath = `/api/v1/organizations/{organizationId}`.replace(
                `{${'organizationId'}}`,
        ...
        updateOrganization: async (
            ...
            // verify required parameter 'organizationDTO' is not null or undefined
            assertParamExists('updateOrganization', 'organizationDTO', organizationDTO);
            const localVarPath = `/api/v1/organizations/{organizationId}`.replace(
                `{${'organizationId'}}`,
                encodeURIComponent(String(organizationId)),
            );
...
export const OrganizationsApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async getAllOrganizations(
            ...
            (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<OrganizationDTO>>
        > {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getAllOrganizations(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['OrganizationsApi.getAllOrganizations']?.[
                    localVarOperationServerIndex
                ]?.url;
            return (axios, basePath) =>
                createRequestFunction(
        ...
        async getOrganizationById(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.getOrganizationById(
                organizationId,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['OrganizationsApi.getOrganizationById']?.[
                    localVarOperationServerIndex
                ]?.url;
            return (axios, basePath) =>
                createRequestFunction(
...
export const OrganizationsApiFactory = function (
    ...
    return {
        ...
        createOrganization(
            ...
            return localVarFp
                .createOrganization(organizationDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        getAllOrganizations(options?: RawAxiosRequestConfig): AxiosPromise<Array<OrganizationDTO>> {
            return localVarFp
        ...
        getOrganizationById(
            ...
            return localVarFp
                .getOrganizationById(organizationId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateOrganization(
            ...
            return localVarFp
                .updateOrganization(organizationId, organizationDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class OrganizationsApi extends BaseAPI {
     ...
     */
    public createOrganization(organizationDTO: OrganizationDTO, options?: RawAxiosRequestConfig) {
     ...
     * @memberof OrganizationsApi
     */
    public getOrganizationById(organizationId: string, options?: RawAxiosRequestConfig) {
        return OrganizationsApiFp(this.configuration)
            .getOrganizationById(organizationId, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const PermissionsApiFactory = function (
    ...
    return {
        ...
        createPermission(
            ...
            return localVarFp
                .createPermission(permissionDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        deletePermission(
            ...
            return localVarFp
                .deletePermission(permissionId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getPermissionById(
            ...
            return localVarFp
                .getPermissionById(permissionId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updatePermission(
            ...
            return localVarFp
                .updatePermission(permissionId, permissionDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class PermissionsApi extends BaseAPI {
     ...
     * @memberof PermissionsApi
     */
    public deletePermission(permissionId: string, options?: RawAxiosRequestConfig) {
        return PermissionsApiFp(this.configuration)
            .deletePermission(permissionId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof PermissionsApi
     */
    public getPermissionById(permissionId: string, options?: RawAxiosRequestConfig) {
        return PermissionsApiFp(this.configuration)
            .getPermissionById(permissionId, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const ProjectsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getServicesByProjectId: async (
            projectId: string,
            options: RawAxiosRequestConfig = {},
        ): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
            assertParamExists('getServicesByProjectId', 'projectId', projectId);
            const localVarPath = `/api/v1/projects/{projectId}/services`.replace(
                `{${'projectId'}}`,
                encodeURIComponent(String(projectId)),
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProjectsApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async getServicesByProjectId(
            projectId: string,
            options?: RawAxiosRequestConfig,
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ServiceDTO>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getServicesByProjectId(
                projectId,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['ProjectsApi.getServicesByProjectId']?.[
                    localVarOperationServerIndex
                ]?.url;
            return (axios, basePath) =>
                createRequestFunction(
...
export const ProjectsApiFactory = function (
    ...
    return {
        ...
        createProject(
            ...
            return localVarFp
                .createProject(projectDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        getServicesByProjectId(
            projectId: string,
            options?: RawAxiosRequestConfig,
        ): AxiosPromise<Array<ServiceDTO>> {
            return localVarFp
                .getServicesByProjectId(projectId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateProject(
            ...
            return localVarFp
                .updateProject(projectId, projectDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class ProjectsApi extends BaseAPI {
     ...
     */
    public createProject(projectDTO: ProjectDTO, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ProjectsApi
     */
    public getProjectById(projectId: string, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration)
            .getProjectById(projectId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ProjectsApi
     */
    public getServicesByProjectId(projectId: string, options?: RawAxiosRequestConfig) {
        return ProjectsApiFp(this.configuration)
            .getServicesByProjectId(projectId, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const RolesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        addPermissionToRole: async (
            ...
            const localVarPath = `/api/v1/roles/{roleId}/permissions/{permissionId}`
                .replace(`{${'roleId'}}`, encodeURIComponent(String(roleId)))
...
export const RolesApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async addPermissionToRole(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.addPermissionToRole(
                roleId,
                permissionId,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['RolesApi.addPermissionToRole']?.[localVarOperationServerIndex]
                    ?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
        ...
        async removePermissionFromRole(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.removePermissionFromRole(
                roleId,
                permissionId,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['RolesApi.removePermissionFromRole']?.[
                    localVarOperationServerIndex
                ]?.url;
            return (axios, basePath) =>
                createRequestFunction(
...
export const RolesApiFactory = function (
    ...
    return {
        ...
        addPermissionToRole(
            ...
            return localVarFp
                .addPermissionToRole(roleId, permissionId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        createRole(roleDTO: RoleDTO, options?: RawAxiosRequestConfig): AxiosPromise<RoleDTO> {
            return localVarFp
                .createRole(roleDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        deleteRole(roleId: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp
        ...
        getPermissionsByRoleId(
            ...
            return localVarFp
                .getPermissionsByRoleId(roleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        getRoleById(roleId: string, options?: RawAxiosRequestConfig): AxiosPromise<RoleDTO> {
            return localVarFp
                .getRoleById(roleId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        removePermissionFromRole(
            ...
            return localVarFp
                .removePermissionFromRole(roleId, permissionId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateRole(
            ...
            return localVarFp
                .updateRole(roleId, roleDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class RolesApi extends BaseAPI {
     ...
     * @memberof RolesApi
     */
    public createRole(roleDTO: RoleDTO, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration)
            .createRole(roleDTO, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolesApi
     */
    public getPermissionsByRoleId(roleId: string, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration)
            .getPermissionsByRoleId(roleId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolesApi
     */
    public getRoleById(roleId: string, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration)
            .getRoleById(roleId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof RolesApi
     */
    public updateRole(roleId: string, roleDTO: RoleDTO, options?: RawAxiosRequestConfig) {
        return RolesApiFp(this.configuration)
            .updateRole(roleId, roleDTO, options)
            .then((request) => request(this.axios, this.basePath));
    }
...
export const ServicesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        createService: async (
            ...
            // verify required parameter 'serviceDTO' is not null or undefined
            assertParamExists('createService', 'serviceDTO', serviceDTO);
        ...
        deleteService: async (
            ...
            const localVarPath = `/api/v1/services/{serviceId}`.replace(
                `{${'serviceId'}}`,
        ...
        updateService: async (
            ...
            // verify required parameter 'serviceDTO' is not null or undefined
            assertParamExists('updateService', 'serviceDTO', serviceDTO);
            const localVarPath = `/api/v1/services/{serviceId}`.replace(
                `{${'serviceId'}}`,
                encodeURIComponent(String(serviceId)),
            );
...
export const ServicesApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async createService(
            serviceDTO: ServiceDTO,
            options?: RawAxiosRequestConfig,
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ServiceDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createService(
                serviceDTO,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['ServicesApi.createService']?.[localVarOperationServerIndex]
                    ?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
        ...
        async deleteService(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteService(
                serviceId,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['ServicesApi.deleteService']?.[localVarOperationServerIndex]
                    ?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
        ...
        async getAllServices(
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['ServicesApi.getAllServices']?.[localVarOperationServerIndex]
                    ?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
        ...
        async getServiceById(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.getServiceById(
                serviceId,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['ServicesApi.getServiceById']?.[localVarOperationServerIndex]
                    ?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
        ...
        async updateService(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateService(
                serviceId,
                serviceDTO,
                options,
            );
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath =
                operationServerMap['ServicesApi.updateService']?.[localVarOperationServerIndex]
                    ?.url;
            return (axios, basePath) =>
                createRequestFunction(
                    localVarAxiosArgs,
...
export const ServicesApiFactory = function (
    ...
    return {
        ...
        createService(
            serviceDTO: ServiceDTO,
            options?: RawAxiosRequestConfig,
        ): AxiosPromise<ServiceDTO> {
            return localVarFp
                .createService(serviceDTO, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
         ...
         * @throws {RequiredError}
         */
        deleteService(serviceId: string, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp
        ...
        getServiceById(
            ...
            return localVarFp
                .getServiceById(serviceId, options)
                .then((request) => request(axios, basePath));
        },
        /**
         *
        ...
        updateService(
            ...
            return localVarFp
                .updateService(serviceId, serviceDTO, options)
                .then((request) => request(axios, basePath));
        },
    };
};
...
export class ServicesApi extends BaseAPI {
     ...
     */
    public createService(serviceDTO: ServiceDTO, options?: RawAxiosRequestConfig) {
     ...
     * @memberof ServicesApi
     */
    public deleteService(serviceId: string, options?: RawAxiosRequestConfig) {
        return ServicesApiFp(this.configuration)
            .deleteService(serviceId, options)
            .then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ServicesApi
     */
    public getServiceById(serviceId: string, options?: RawAxiosRequestConfig) {
        return ServicesApiFp(this.configuration)
            .getServiceById(serviceId, options)
            .then((request) => request(this.axios, this.basePath));
    }
